...
namespace MagicVilla_CouponAPI.Repository
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public AuthRepository(ApplicationDbContext db, IMapper mapper, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration)
        {
            _db = db;
            _mapper = mapper;
        ...
        {
            var user = await _db.ApplicationUsers.SingleOrDefaultAsync(x => x.UserName == loginRequestDTO.UserName);
        ...
        public async Task<UserDTO> Register(RegisterationRequestDTO requestDTO)
        {
            ...
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var user = await _db.ApplicationUsers.FirstOrDefaultAsync(u => u.UserName == requestDTO.UserName);
